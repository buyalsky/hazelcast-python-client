    ...
    def register_class_definition(self, cd, factory_map, check_error):
        ...
        for field_name in field_names:
            ...
            if fd.field_type == FieldType.PORTABLE or fd.field_type == FieldType.PORTABLE_ARRAY:
                factory_id = fd.class_def.factory_id
                class_id = fd.class_def.class_id
                class_def_map = factory_map[factory_id]
                nested_cd = fd.class_def or class_def_map.get(class_id, None)
